...
class TennisBallDetector:  
    ...
    def split_data(self, images, labels, coordinates, train_split=0.9):  
        ...
        return (  
            X_train,   
            {'class_output': y_train_class, 'bounding_box': y_train_coord},  
            X_val,   
            {'class_output': y_val_class, 'bounding_box': y_val_coord}  
        )  
    ...
    def prepare_labels(self, y_train, y_val):
        ...
        y_train_coordinates = np.array(y_train['bounding_box'])  # (N, 4)
        y_val_coordinates   = np.array(y_val['bounding_box'])    # (N, 4)
    ...
    def train(self, X_train, y_train, X_val, y_val):  
        ...
        #assert y_train['class_output'].shape[0] == y_train['bounding_box'].shape[0], "Mismatch in number of samples"  
